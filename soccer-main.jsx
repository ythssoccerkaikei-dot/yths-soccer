                              ...
                              <div className="flex justify-between items-start">
                                <div className="flex-1">
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                      <label className="block text-sm font-medium text-gray-700 mb-1">月額会費（円）</label>
                                      <input
                                        type="number"
                                  ...
                                  {!member.active && (
                                    <span className="inline-block mt-3 px-2 py-1 bg-gray-200 text-gray-600 text-xs rounded">
                                      退部
                                    </span>
                                  )}
                                </div>
